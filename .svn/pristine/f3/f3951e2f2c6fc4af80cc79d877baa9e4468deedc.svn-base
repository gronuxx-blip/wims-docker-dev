...
!if noclass=$error
  ...
  Si está jugando con el sitio, tenga en cuenta que todas sus actividades están registradas.
  !exit
!endif
...
!if login_empty=$error
  No se pudo crear el identificador porque los datos están vacíos.
  Verifique la configuración de autenticación o el identificador externo.
  !exit
!endif
