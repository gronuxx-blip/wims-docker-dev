...
!set name_inscription2=!nosubst Se está registrando como participante en $forumname, con identificador de usuario &nbsp;
!exit
...
:code
 $forumname no permite la inscripción anónima. Utiliza la dirección de
  correo electrónico que ha proporcionado para identificarle (con el objeto de prevenir abusos).
  <p>
