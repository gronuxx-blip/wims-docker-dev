...
!if $job=neighbor
 ...
 name_import_resource,name_youcan,name_fromtheclass,name_click_ok,name_userphoto,name_tool,name_importres
  ...
  !set name_warning_duplicate=Seules les feuilles dont les contenus (sources des feuilles) \
  sont différents sont importables. Vous pouvez ensuite dupliquer une feuille si vous désirez\
  avoir deux feuilles de contenu identique.
