...
!set name_intro=Este módulo tiene como objetivo ayudar a la confección del \
  fichero fuente de un ejercicio sencillo en el formato OEF en WIMS.

!set name_intro1=Este módulo trata de la confección de ejercicios OEF de tres tipos:

!distribute line  OEF de tipo QCM  con una lista de botones para seleccionar\
   OEF con respuesta libre que deberá dar el usuario\
   OEF combinación de los dos tipos precedentes\
into name_type1, name_type2, name_type3
...
!set name_help=Lo sentimos, pero la ayuda está aún en construcción.
