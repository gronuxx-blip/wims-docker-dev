...
!set name_warning=Si crea un foro de discusión en este sitio WIMS, debe asumir la \
...
:step1
Está creando el foro de discusión $forumname en el sitio
WIMS en
$httpd_HTTP_HOST.
<p>
...
!href module=$module&cmd=reply&step=0 corríjala.
 ...
 De lo contrario, para verificar la corrección de las contraseñas,
...
nuevo foro de discusión bajo WIMS en este sitio $httpd_HTTP_HOST.
<p>
 ...
 electrónico (espere unos minutos si es necesario), y lea el mensaje 
...
:step3
Se ha creado el foro de discusión $forumname.
¡Felicidades, y diviértase!
<p>
