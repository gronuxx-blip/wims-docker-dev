...
!set pointcoord=!nosubst het punt $(M_objet[1]) met co&ouml;rdinaten ($(M_objet[3..$3dcnt]))
!set vectorcoord=!nosubst de vector $(M_objet[1]) met co&ouml;rdinaat ($(M_objet[3..$3dcnt]))
