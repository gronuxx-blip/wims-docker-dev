...
name_search_leveltrans_help=Busque también en módulos que no definen un nivel (por ejemplo, para idiomas)
name_search_method=Método
name_search_category=Categoría
name_search_filters=Filtros
name_search_level_class_help=Por defecto, el rango del nivel se establece a partir del nivel de la clase.
