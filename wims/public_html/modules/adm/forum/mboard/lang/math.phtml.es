...
griegas en su mensaje, no tiene más que escribir una 
<span class="tt">\</span>  seguida por el nombre del símbolo o de la letra griega. Por ejemplo, 
...
$m_rightarrow, etc. Los nombres de los símbolos siguen la convención
...
Puede obtener más ayuda acerca de cómo introducir expresiones matemáticas en
...
le permite comprobar si la fórmula que ha introducido se mostrará correctamente.
</p>
