...
!set n_following=ContinuSubjectación de
...
!set $n_statusask= Este foro de discusión no acepta mensajes anónimos. Utiliza la dirección de correo \
 electrónico actual que usted ha proporcionado, para conservar su identidad, con objeto de evitar abusos.<p>\
 Para verificar la validez de su dirección de correo, el servidor le ha \
 enviado una clave secreta por correo. Por favor lea ese e-mail, y copie la clave aquí:
