...
<p>
Para enviar datos desde su hoja de cálculo a la clase, guarde los datos en un archivo de texto (txt, csv o tsv), luego envíe el archivo al servidor.
</p>
$table_header
<caption>Campos de datos válidos</caption>
...
$table_tr<td class="tt wims_code_variable">login</td>
  <td>identificación del profesor que controla la clase
...
$table_tr<td class="tt wims_code_variable">regpass</td><td>contraseña de inscripción a la clase.</td></tr>
$table_tr<td class="tt wims_code_variable">secure</td><td>accesos seguros a la clase (IP o all).</td></tr>
$table_tr<td class="tt wims_code_variable">limit</td><td>número máximo de alumnos.</td></tr>
$table_end
Las columnas <span class="wims_code_variable">regpass, secure, limit</span> no son obligatorias.
Se les dará los valores por omisión si no están presentes.
