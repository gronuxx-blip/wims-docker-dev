...
!set name_cgu=Ik heb de gebruiksvoorwaarden gelezen en accepteer deze.
...
!set noagreecgu_msg=Er kan zonder acceptatie van de gebruiksvoorwaarden op deze server, geen klassen worden aangemaakt 
...
Als hier niets wordt ingevuld, wordt bij elke handeling eerst een goedkeurings emailtje verstuurd.\
