...
!distribute items Registration,Aanmelden,Anoniem,openbaar,besloten,Jaar,\
Nieuwe deelnemer,aanmelden,Inloggen,&#8679;,Kopieren\
...
<p>Nog niet aangemeld? klik dan op <span class="wims_button disabled">$name_register</span>\
 (als de status heet <span class="wims_label wims_warning">$name_protected</span>, is er een wachtwoord vereist voor de aanmeldings procedure.\
...
!set name_sendmailmess=Er wordt een email gestuurd met een nieuw wachtwoord naar het opgegeven emailadres (mits deze server mail verstuurd...).
