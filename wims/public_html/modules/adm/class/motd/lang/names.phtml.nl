...
!set name_home=Hoofdpagina van de klas

!set name_Intro=Op deze pagina kunt u een algemene of persoonlijke mededeling schrijven aan\
alle studenten van deze klas.
...
!set name_expert0=Er zijn meerdere methodes om studenten te selecteren.
