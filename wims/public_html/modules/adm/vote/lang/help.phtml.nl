...
!readproc adm/lang/sheetexam.phtml.$lang
  ...
  <b>$name_group</b> :
  Er kunnen ook groepjes studenten worden gedefinieerd.
...
<br>
De modules <span class="tt wims_code_words">$name_free</span> en <span class="tt wims_code_words">$name_group</span> zijn niet beschikbaar wanneer de vragenlijsten met een andere klas worden gedeeld.
