...
!set name_techanalysis=Análisis técnico
...
!if $level=7
  ...
  name_choice_filename=Nombre del fichero de código del ejercicio
  name_choice_filename_help=(utilizar solo caracteres alfanuméricos)
